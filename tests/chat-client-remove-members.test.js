...
describe('ChatClient', () => {
  ...
  describe('removeChatMembers', () => {
    it('should remove members from a chat with minimal parameters', async () => {
      const chatId = 'test-chat-id';
      const params = {
        id_list: ['user1', 'user2', 'user3'],
      };

      const result = await chatClient.removeChatMembers(chatId, params);
    ...
    it('should remove members from a chat with all parameters', async () => {
      const chatId = 'test-chat-id';
      const params = {
        id_list: ['user1', 'user2', 'user3'],
        member_type: 'user',
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        chatClient.removeChatMembers(chatId, params),
